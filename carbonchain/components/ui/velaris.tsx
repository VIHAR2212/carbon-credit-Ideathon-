...
// CarbonChain default palette — muted emerald/amber, no purple/blue,
// matching the app's toned-down brand colors rather than a neon preset.
const DEFAULT_COLORS = ["#0d9668", "#22a67a", "#b45309", "#0a0b0d"];
